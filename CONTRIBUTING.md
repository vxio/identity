...
First, [Fork our project](https://github.com/moov-io/identity) somewhere and after that's done add the remote:

```
$ cd moov/identity # Whereever this project's source code is

$ git remote add $user git@github.com:$user/identity.git # After
...
Our Build pipeline utilizes [Travis-CI](https://travis-ci.org/moov-io/identity) to enforce many tools that you should add to your editor before issuing a pull request. Learn more about these tools on our [Go Report card](https://goreportcard.com/report/github.com/moov-io/identity)