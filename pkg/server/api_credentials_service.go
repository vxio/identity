...
// CredentialsApiService is a service that implents the logic for the CredentialsApiServicer
// This service should implement the business logic for every endpoint for the CredentialsApi API. 
// Include any external packages or services that will be required by this service.
type CredentialsApiService struct {
}

// NewCredentialsApiService creates a default api service
func NewCredentialsApiService() CredentialsApiServicer {
	return &CredentialsApiService{}
}

// DisableCredentials - Disables a credential so it can&#39;t be used anymore to login
func (s *CredentialsApiService) DisableCredentials(identityID string, credentialID string) (interface{}, error) {
...
func (s *CredentialsApiService) ListCredentials(identityID string) (interface{}, error) {
