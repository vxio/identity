...
// InternalApiService is a service that implents the logic for the InternalApiServicer
...
// NewInternalApiService creates a default api service
func NewInternalApiService() InternalApiServicer {
