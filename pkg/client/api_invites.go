...
// InvitesGetOpts Optional parameters for the method 'InvitesGet'
type InvitesGetOpts struct {
 ...
 * @param optional nil or *InvitesGetOpts - Optional Parameters:
 * @param "OrgID" (optional.Interface of string) -  Filter in only for specific Organization
@return []Invite
*/
func (a *InvitesApiService) InvitesGet(ctx _context.Context, localVarOptionals *InvitesGetOpts) ([]Invite, *_nethttp.Response, error) {
	var (
...
*/
func (a *InvitesApiService) InvitesInviteIDDelete(ctx _context.Context, inviteID string) (*_nethttp.Response, error) {
	var (
...
@return Invite
*/
func (a *InvitesApiService) InvitesPost(ctx _context.Context, invite Invite) (Invite, *_nethttp.Response, error) {
	var (
